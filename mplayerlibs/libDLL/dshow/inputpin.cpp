...
{
    mp_msg(0,0,"%s(%p) called (UNIMPLEMENTED)", s, p);
    return E_NOTIMPL;
}
...
static long __stdcall CEnumPins_Next(IEnumPins* This,
                                   ...
                                   /* [out] */ unsigned long* pcFetched)
{
    ...
    //mp_msg(0,0,"CEnumPins_Next(%p) called\n", This);
    if (!ppMediaTypes)
		{
				mp_msg(0,0,"failed CEnumPins_Next");
        return E_INVALIDARG;
		}
...
static long __stdcall  CEnumPins_Skip(IEnumPins* This,
                                   /* [in] */ unsigned long cMediaTypes)
{
    //mp_msg(0,0,"CEnumPins_Skip", This);
    return E_NOTIMPL;
}

static long __stdcall  CEnumPins_Reset(IEnumPins* This)
{
    //mp_msg(0,0,"CEnumPins_Reset(%p) called\n", This);
    ((CEnumPins*)This)->counter = 0;
    return 0;
}

static long __stdcall  CEnumPins_Clone(IEnumPins* This,
                                    /* [out] */ IEnumPins** ppEnum)
{
    //mp_msg(0,0,"CEnumPins_Clone", This);
    return E_NOTIMPL;
}
...
static long __stdcall  CInputPin_Connect(IPin* This,
                                      /* [in] */ IPin* pReceivePin,
                                      /* [in] */ AM_MEDIA_TYPE* pmt)
{
    //mp_msg(0,0,"CInputPin_Connect", This);
    return E_NOTIMPL;
}

static long __stdcall  CInputPin_ReceiveConnection(IPin* This,
        /* [in] */ IPin* pConnector,
        /* [in] */ const AM_MEDIA_TYPE *pmt)
{
    //mp_msg(0,0,"CInputPin_ReceiveConnection", This);
    return E_NOTIMPL;
}

static long __stdcall  CInputPin_Disconnect(IPin* This)
{
    //mp_msg(0,0,"CInputPin_Disconnect", This);
    return E_NOTIMPL;
}

static long __stdcall  CInputPin_ConnectedTo(IPin* This,
        /* [out] */ IPin** pPin)
{
    //mp_msg(0,0,"CInputPin_ConnectedTo", This);
    return E_NOTIMPL;
}

static long __stdcall  CInputPin_ConnectionMediaType(IPin* This,
        /* [out] */ AM_MEDIA_TYPE *pmt)
{
    //mp_msg(0,0,"CInputPin_ConnectionMediaType(%p) called\n", This);
    if (!pmt)
		{
				mp_msg(0,0,"failed CInputPin_ConnectionMediaType");
        return E_INVALIDARG;
		}
...
static long __stdcall  CInputPin_QueryPinInfo(IPin* This,
        /* [out] */ PIN_INFO *pInfo)
{
    CBaseFilter* lparent=((CInputPin*)This)->parent;
    //mp_msg(0,0,"CInputPin_QueryPinInfo(%p) called\n", This);
...
static long __stdcall  CInputPin_QueryDirection(IPin* This,
        /* [out] */ PIN_DIRECTION *pPinDir)
{
    *pPinDir = PINDIR_OUTPUT;
    //mp_msg(0,0,"CInputPin_QueryDirection(%p) called\n", This);
    return 0;
}

static long __stdcall  CInputPin_QueryId(IPin* This,
                                      /* [out] */ unsigned short* *Id)
{
    //mp_msg(0,0,"CInputPin_QueryId", This);
    return E_NOTIMPL;
}

static long __stdcall  CInputPin_QueryAccept(IPin* This,
        /* [in] */ const AM_MEDIA_TYPE* pmt)
{
    //mp_msg(0,0,"CInputPin_QueryAccept", This);
    return E_NOTIMPL;
}

static long __stdcall  CInputPin_EnumMediaTypes(IPin* This,
        /* [out] */ IEnumMediaTypes** ppEnum)
{
    //mp_msg(0,0,"CInputPin_EnumMediaTypes", This);
    return E_NOTIMPL;
}

static long __stdcall  CInputPin_QueryInternalConnections(IPin* This,
        /* [out] */ IPin** apPin,
        /* [out][in] */ unsigned long *nPin)
{
    //mp_msg(0,0,"CInputPin_QueryInternalConnections", This);
    return E_NOTIMPL;
}

static long __stdcall  CInputPin_EndOfStream(IPin * This)
{
    //mp_msg(0,0,"CInputPin_EndOfStream", This);
    return E_NOTIMPL;
}


static long __stdcall  CInputPin_BeginFlush(IPin * This)
{
    //mp_msg(0,0,"CInputPin_BeginFlush", This);
    return E_NOTIMPL;
}


static long __stdcall  CInputPin_EndFlush(IPin* This)
{
    //mp_msg(0,0,"CInputPin_EndFlush", This);
    return E_NOTIMPL;
}

static long __stdcall  CInputPin_NewSegment(IPin* This,
        /* [in] */ REFERENCE_TIME tStart,
        /* [in] */ REFERENCE_TIME tStop,
        /* [in] */ double dRate)
{
    //mp_msg(0,0,"CInputPin_NewSegment", This);
    return E_NOTIMPL;
}
...
static long __stdcall  CBaseFilter_GetClassID(IBaseFilter * This,
        /* [out] */ CLSID *pClassID)
{
    //mp_msg(0,0,"CBaseFilter_GetClassID", This);
    return E_NOTIMPL;
}

static long __stdcall  CBaseFilter_Stop(IBaseFilter* This)
{
    //mp_msg(0,0,"CBaseFilter_Stop", This);
    return E_NOTIMPL;
}

static long __stdcall  CBaseFilter_Pause(IBaseFilter* This)
{
    //mp_msg(0,0,"CBaseFilter_Pause", This);
    return E_NOTIMPL;
}

static long __stdcall  CBaseFilter_Run(IBaseFilter* This, REFERENCE_TIME tStart)
{
    //mp_msg(0,0,"CBaseFilter_Run", This);
    return E_NOTIMPL;
}

static long __stdcall  CBaseFilter_GetState(IBaseFilter* This,
        /* [in] */ unsigned long dwMilliSecsTimeout,
        // /* [out] */ FILTER_STATE *State)
        void* State)
{
    //mp_msg(0,0,"CBaseFilter_GetState", This);
    return E_NOTIMPL;
}

static long __stdcall  CBaseFilter_SetSyncSource(IBaseFilter* This,
        /* [in] */ IReferenceClock *pClock)
{
    //mp_msg(0,0,"CBaseFilter_SetSyncSource", This);
    return E_NOTIMPL;
}

static long __stdcall  CBaseFilter_GetSyncSource(IBaseFilter* This,
        /* [out] */ IReferenceClock **pClock)
{
    //mp_msg(0,0,"CBaseFilter_GetSyncSource", This);
    return E_NOTIMPL;
}


static long __stdcall  CBaseFilter_EnumPins(IBaseFilter* This,
        /* [out] */ IEnumPins **ppEnum)
{
    //mp_msg(0,0,"CBaseFilter_EnumPins(%p) called\n", This);
    *ppEnum = (IEnumPins*) CEnumPinsCreate(((CBaseFilter*)This)->pin, ((CBaseFilter*)This)->unused_pin);
    return 0;
}

static long __stdcall  CBaseFilter_FindPin(IBaseFilter* This,
                                        /* [string][in] */ const unsigned short* Id,
                                        /* [out] */ IPin **ppPin)
{
    //mp_msg(0,0,"CBaseFilter_FindPin\n", This);
    return E_NOTIMPL;
}

static long __stdcall  CBaseFilter_QueryFilterInfo(IBaseFilter* This,
        // /* [out] */ FILTER_INFO *pInfo)
        void* pInfo)
{
    //mp_msg(0,0,"CBaseFilter_QueryFilterInfo", This);
    return E_NOTIMPL;
}

static long __stdcall  CBaseFilter_JoinFilterGraph(IBaseFilter* This,
        /* [in] */ IFilterGraph* pGraph,
        /* [string][in] */ const unsigned short* pName)
{
    //mp_msg(0,0,"CBaseFilter_JoinFilterGraph", This);
    return E_NOTIMPL;
}

static long __stdcall  CBaseFilter_QueryVendorInfo(IBaseFilter* This,
        /* [string][out] */ unsigned short** pVendorInfo)
{
    //mp_msg(0,0,"CBaseFilter_QueryVendorInfo", This);
    return E_NOTIMPL;
}
...
static long __stdcall  CBaseFilter2_GetClassID(IBaseFilter* This,
        /* [out] */ CLSID* pClassID)
{
    //mp_msg(0,0,"CBaseFilter2_GetClassID", This);
    return E_NOTIMPL;
}

static long __stdcall  CBaseFilter2_Stop(IBaseFilter* This)
{
    //mp_msg(0,0,"CBaseFilter2_Stop", This);
    return E_NOTIMPL;
}

static long __stdcall  CBaseFilter2_Pause(IBaseFilter* This)
{
    //mp_msg(0,0,"CBaseFilter2_Pause", This);
    return E_NOTIMPL;
}

static long __stdcall  CBaseFilter2_Run(IBaseFilter* This, REFERENCE_TIME tStart)
{
    //mp_msg(0,0,"CBaseFilter2_Run", This);
    return E_NOTIMPL;
}


static long __stdcall  CBaseFilter2_GetState(IBaseFilter* This,
        /* [in] */ unsigned long dwMilliSecsTimeout,
        // /* [out] */ FILTER_STATE *State)
        void* State)
{
    //mp_msg(0,0,"CBaseFilter2_GetState", This);
    return E_NOTIMPL;
}

static long __stdcall  CBaseFilter2_SetSyncSource(IBaseFilter* This,
        /* [in] */ IReferenceClock* pClock)
{
    //mp_msg(0,0,"CBaseFilter2_SetSyncSource", This);
    return E_NOTIMPL;
}

static long __stdcall  CBaseFilter2_GetSyncSource(IBaseFilter* This,
        /* [out] */ IReferenceClock** pClock)
{
    //mp_msg(0,0,"CBaseFilter2_GetSyncSource", This);
    return E_NOTIMPL;
}

static long __stdcall  CBaseFilter2_EnumPins(IBaseFilter* This,
        /* [out] */ IEnumPins** ppEnum)
{
    //mp_msg(0,0,"CBaseFilter2_EnumPins(%p) called\n", This);
    *ppEnum = (IEnumPins*) CEnumPinsCreate(((CBaseFilter2*)This)->pin, 0);
    return 0;
}

static long __stdcall  CBaseFilter2_FindPin(IBaseFilter* This,
        /* [string][in] */ const unsigned short* Id,
        /* [out] */ IPin** ppPin)
{
    //mp_msg(0,0,"CBaseFilter2_FindPin", This);
    return E_NOTIMPL;
}

static long __stdcall  CBaseFilter2_QueryFilterInfo(IBaseFilter* This,
        // /* [out] */ FILTER_INFO *pInfo)
        void* pInfo)
{
    //mp_msg(0,0,"CBaseFilter2_QueryFilterInfo", This);
    return E_NOTIMPL;
}

static long __stdcall  CBaseFilter2_JoinFilterGraph(IBaseFilter* This,
        /* [in] */ IFilterGraph* pGraph,
        /* [string][in] */
        const unsigned short* pName)
{
    //mp_msg(0,0,"CBaseFilter2_JoinFilterGraph", This);
    return E_NOTIMPL;
}

static long __stdcall  CBaseFilter2_QueryVendorInfo(IBaseFilter* This,
        /* [string][out] */
        unsigned short** pVendorInfo)
{
    //mp_msg(0,0,"CBaseFilter2_QueryVendorInfo", This);
    return E_NOTIMPL;
}
...
{
    //mp_msg(0,0,"CBaseFilter2_Destroy(%p) called\n", This);
    if (This->pin)
        This->pin->vt->Release((IUnknown*) This->pin);
    if (This->vt)
        free(This->vt);
...
static long __stdcall  CRemotePin_ConnectedTo(IPin* This, /* [out] */ IPin** pPin)
{
    //mp_msg(0,0,"CRemotePin_ConnectedTo(%p) called\n", This);
    if (!pPin)
		{
				mp_msg(0,0,"failed CRemotePin_ConnectedTo");
        return E_INVALIDARG;
		}
...
static long __stdcall  CRemotePin_QueryDirection(IPin* This,
        /* [out] */ PIN_DIRECTION* pPinDir)
{
    //mp_msg(0,0,"CRemotePin_QueryDirection(%p) called\n", This);
    if (!pPinDir)
		{
				mp_msg(0,0,"failed CRemotePin_QueryDirection");
        return E_INVALIDARG;
		}
...
static long __stdcall  CRemotePin_ConnectionMediaType(IPin* This, /* [out] */ AM_MEDIA_TYPE* pmt)
{
    //mp_msg(0,0,"CRemotePin_ConnectionMediaType", This);
    return E_NOTIMPL;
}

static long __stdcall  CRemotePin_QueryPinInfo(IPin* This, /* [out] */ PIN_INFO* pInfo)
{
    CBaseFilter* lparent = ((CRemotePin*)This)->parent;
    //mp_msg(0,0,"CRemotePin_QueryPinInfo(%p) called\n", This);
...
{
    //mp_msg(0,0,"CRemotePin_Destroy(%p) called\n", This);
    free(This->vt);
    free(This);
}
...
CRemotePin* CRemotePinCreate(CBaseFilter* pt, IPin* rpin)
{
    ...
    //mp_msg(0,0,"CRemotePinCreate() called -> %p\n", This);
...
static long __stdcall  CRemotePin2_QueryPinInfo(IPin* This,
        /* [out] */ PIN_INFO* pInfo)
{
    CBaseFilter2* lparent=((CRemotePin2*)This)->parent;
    //mp_msg(0,0,"CRemotePin2_QueryPinInfo(%p) called\n", This);
    pInfo->pFilter=(IBaseFilter*)lparent;
    lparent->vt->AddRef((IUnknown*)lparent);
    pInfo->dir=PINDIR_OUTPUT;
    pInfo->achName[0]=0;
...
{
    //mp_msg(0,0,"CRemotePin2_Destroy(%p) called\n", This);
    free(This->vt);
    free(This);
}
...
CRemotePin2* CRemotePin2Create(CBaseFilter2* p)
{
    ...
    //mp_msg(0,0,"CRemotePin2Create() called -> %p\n", This);
