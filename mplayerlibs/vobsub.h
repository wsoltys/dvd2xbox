...
extern int vobsub_parse_ifo(void* pthis, const char *const name, unsigned int *palette, unsigned int *width, unsigned int *height, int force, int sid, char *langid);
...
extern void vobsub_close(void *pthis);
