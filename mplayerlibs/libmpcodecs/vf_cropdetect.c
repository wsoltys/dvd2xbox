...
*/
		//if (vf->priv->iDetected==0)
		{
			if(bAutoCrop )
			{
						vf->priv->fno=0;
						vf->priv->x1=mpi->width;
						vf->priv->y1=
							mpi->height;
						vf->priv->x2=0;
						vf->priv->y2=0;
				...
				// ignore first 2 frames - they may be empty
					...
					if ( (vf->priv->x1==0 && vf->priv->y1==0) ||
							 (x==mpi->width || y ==mpi->height) )
					{
						vf->priv->fno=0;
						vf->priv->x1=mpi->width;
						vf->priv->y1=mpi->height;
						vf->priv->x2=0;
						vf->priv->y2=0;
					...
					else
					{
						...
						mp_msg(0,0,"crop area: X: %d..%d  Y: %d..%d  (-vop crop=%d:%d:%d:%d)\n",
