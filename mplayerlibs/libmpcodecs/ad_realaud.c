...
#ifdef USE_WIN32DLL
static unsigned long (__stdcall *wraCloseCodec)(void*);
static unsigned long (__stdcall *wraDecode)(void*, char*,unsigned long,char*,unsigned int*,long);
static unsigned long (__stdcall *wraFlush)(unsigned long,unsigned long,unsigned long);
static unsigned long (__stdcall *wraFreeDecoder)(void*);
static void*         (__stdcall *wraGetFlavorProperty)(void*,unsigned long,unsigned long,int*);
static unsigned long (__stdcall *wraInitDecoder)(void*, void*);
static unsigned long (__stdcall *wraOpenCodec)(void*);
static unsigned long (__stdcall *wraOpenCodec2)(void*, void*);
static unsigned long (__stdcall *wraSetFlavor)(void*,unsigned long);
static void          (__stdcall *wraSetDLLAccessPath)(char*);
static void          (__stdcall *wraSetPwd)(char*,char*);
...
void* __stdcall GetProcAddress(void* handle,char *func);
int __stdcall FreeLibrary(void *handle);
...
static int preinit(sh_audio_t *sh)
{
    ...
    sprintf(path, "%s\\%s",REALCODEC_PATH , sh->codec->dll);
...
static void uninit(sh_audio_t *sh)
{
    ...
    {
        if (wraFreeDecoder)
            wraFreeDecoder(sh->context);
        if (wraCloseCodec)
            wraCloseCodec(sh->context);
    }
#endif

    if (raFreeDecoder)
        raFreeDecoder(sh->context);
    if (raCloseCodec)
        raCloseCodec(sh->context);
