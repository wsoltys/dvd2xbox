 ...
 *
 * $Id: dvdnav.c,v 1.1 2003/11/04 18:28:56 wiso Exp $
 *
 */
...
dvdnav_status_t dvdnav_get_next_cache_block(dvdnav_t *this, unsigned char **buf,
  ...
  **********/
  ...
  if(this->spu_clut_changed) {
    ...
    this->spu_clut_changed = 0;
#ifdef LOG_DEBUG
    fprintf(stderr,"libdvdnav:SPU_CLUT_CHANGE returning DVDNAV_STATUS_OK\n");
#endif
    pthread_mutex_unlock(&this->vm_lock); 
    return DVDNAV_STATUS_OK;
  }
...
#ifdef LOG_DEBUG
      fprintf(stderr,"libdvdnav:SPU_STREAM_CHANGE returning DVDNAV_STATUS_OK\n");
#endif
      return DVDNAV_STATUS_OK;
    }
  }
...
#ifdef LOG_DEBUG
    fprintf(stderr,"libdvdnav:AUDIO_STREAM_CHANGE stream_id=%d returning DVDNAV_STATUS_OK\n",stream_change.physical);
#endif
    pthread_mutex_unlock(&this->vm_lock); 
    return DVDNAV_STATUS_OK;
  }
...
dvdnav_status_t dvdnav_angle_change(dvdnav_t *this, int angle) {
  ...
  if(dvdnav_get_angle_info(this, &current, &num) != DVDNAV_STATUS_OK) {
...
/*
 * $Log: dvdnav.c,v $
 * Revision 1.1  2003/11/04 18:28:56  wiso
 * Initial revision
 *
 * Revision 1.1.1.1  2003/07/23 22:09:15  cvs
 * Version 0.3.9
 *
 * Revision 1.3  2003/03/25 20:40:33  yamp
 * dvdread 0.94
 *
 * Revision 1.2  2003/03/25 07:08:34  grompf
 * fixed return values to what dvdnav_stream expects
 *
 * Revision 1.1  2003/03/21 19:29:40  yamp
 * libdvdnav patch (disabled for now)
 *
