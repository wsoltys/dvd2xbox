...
#ifdef WORDS_BIGENDIAN
  char  audio_format           : 3;
  char  multichannel_extension : 1;
  char  lang_type              : 2;
  char  application_mode       : 2;
  
  char  quantization           : 2;
  char  sample_frequency       : 2;
  char  unknown1               : 1;
  char  channels               : 3;
#else
  char  application_mode       : 2;
...
#ifdef WORDS_BIGENDIAN
      char  unknown4           : 1;
      char  channel_assignment : 3;
      char  version            : 2;
      char  mc_intro           : 1; /* probably 0: true, 1:false */
      char  mode               : 1; /* Karaoke mode 0: solo 1: duet */
#else
      char  mode               : 1;
      char  mc_intro           : 1;
      char  version            : 2;
...
#ifdef WORDS_BIGENDIAN
      char  unknown5           : 4;
      char  dolby_encoded      : 1; /* suitable for surround decoding */
      char  unknown6           : 3;
#else
      char  unknown6           : 3;
      char  dolby_encoded      : 1;
      char  unknown5           : 4;
#endif
    } surround;
  } app_info;
...
typedef struct {
  ...
  char  block_mode       : 2;
  char  block_type       : 2;
  char  seamless_play    : 1;
  char  interleaved      : 1;
  char  stc_discontinuity: 1;
  char  seamless_angle   : 1;
  
  char  playback_mode    : 1;  /**< When set, enter StillMode after each VOBU */
  char  restricted       : 1;  /**< ?? drop out of fastforward? */
  char  unknown2         : 6;
#else
  char  seamless_angle   : 1;
  char  stc_discontinuity: 1;
...
#ifdef WORDS_BIGENDIAN
  char  zero                           : 7; /* 25-31 */
  char  video_pres_mode_change         : 1; /* 24 */
  
  char  karaoke_audio_pres_mode_change : 1; /* 23 */
  char  angle_change                   : 1;
  char  subpic_stream_change           : 1;
  char  audio_stream_change            : 1;
  char  pause_on                       : 1;
  char  still_off                      : 1;
  char  button_select_or_activate      : 1;
  char  resume                         : 1; /* 16 */
  
  char  chapter_menu_call              : 1; /* 15 */
  char  angle_menu_call                : 1;
  char  audio_menu_call                : 1;
  char  subpic_menu_call               : 1;
  char  root_menu_call                 : 1;
  char  title_menu_call                : 1;
  char  backward_scan                  : 1;
  char  forward_scan                   : 1; /* 8 */
  
  char  next_pg_search                 : 1; /* 7 */
  char  prev_or_top_pg_search          : 1;
  char  time_or_chapter_search         : 1;
  char  go_up                          : 1;
  char  stop                           : 1;
  char  title_play                     : 1;
  char  chapter_search_or_play         : 1;
  char  title_or_time_play             : 1; /* 0 */
#else
  char  video_pres_mode_change         : 1; /* 24 */
  char  zero                           : 7; /* 25-31 */
...
#ifdef WORDS_BIGENDIAN
  char  zero_1                    : 1;
  char  multi_or_random_pgc_title : 1; /* 0: one sequential pgc title */
  char  jlc_exists_in_cell_cmd    : 1;
  char  jlc_exists_in_prepost_cmd : 1;
  char  jlc_exists_in_button_cmd  : 1;
  char  jlc_exists_in_tt_dom      : 1;
  char  chapter_search_or_play    : 1; /* UOP 1 */
  char  title_or_time_play        : 1; /* UOP 0 */
#else
  char  title_or_time_play        : 1;
  char  chapter_search_or_play    : 1;
  char  jlc_exists_in_tt_dom      : 1;
  char  jlc_exists_in_button_cmd  : 1;
  char  jlc_exists_in_prepost_cmd : 1;
  char  jlc_exists_in_cell_cmd    : 1;
  char  multi_or_random_pgc_title : 1;
  char  zero_1                    : 1;
#endif
