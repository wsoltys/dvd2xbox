...
typedef struct {
  ...
  char  zero1 : 2;          /**< reserved */
  char  btngr_ns : 2;       /**< number of button groups 1, 2 or 3 with 36/18/12 buttons */
  char  zero2 : 1;          /**< reserved */
  char  btngr1_dsp_ty : 3;  /**< display type of subpic stream for button group 1 */
  char  zero3 : 1;          /**< reserved */
  char  btngr2_dsp_ty : 3;  /**< display type of subpic stream for button group 2 */
  char  zero4 : 1;          /**< reserved */
  char  btngr3_dsp_ty : 3;  /**< display type of subpic stream for button group 3 */
#else
  char  btngr1_dsp_ty : 3;
  char  zero2 : 1;
  char  btngr_ns : 2;
  char  zero1 : 2;
  char  btngr3_dsp_ty : 3;
  char  zero4 : 1;
  char  btngr2_dsp_ty : 3;
  char  zero3 : 1;
#endif
...
/* Retyped for ms packing to be happy.
 * Huge thanks to Adron for explaining MS fucked up packing
 */
typedef struct {
#ifdef WORDS_BIGENDIAN
  char  btn_coln         : 2;  /**< button color number */
  char  x_start          : 10; /**< x start offset within the overlay */
  char  zero1            : 2;  /**< reserved */
  char  x_end            : 10; /**< x end offset within the overlay */

  char  zero3            : 2;  /**< reserved */
  char  up               : 6;  /**< button index when pressing up */

  char  auto_action_mode : 2;  /**< 0: no, 1: activated if selected */
  char  y_start          : 10; /**< y start offset within the overlay */
  char  zero2            : 2;  /**< reserved */
  char  y_end            : 10; /**< y end offset within the overlay */

  char  zero4            : 2;  /**< reserved */
  char  down             : 6;  /**< button index when pressing down */
  char  zero5            : 2;  /**< reserved */
  char  left             : 6;  /**< button index when pressing left */
  char  zero6            : 2;  /**< reserved */
  char  right            : 6;  /**< button index when pressing right */
#else
