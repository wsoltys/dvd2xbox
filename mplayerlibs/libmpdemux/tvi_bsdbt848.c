...
static void processframe(int signal)
{
    ...
    if(G_private->immediatemode == TRUE)
        return;
    ...
    if(G_private->framebuf[G_private->curpaintframe].dirty == TRUE)
    {
        ...
        if(G_private->curpaintframe >= RINGSIZE)
            G_private->curpaintframe = 0;
    }
...
static int getinput(int innumber)
{
    ...
    {
    case 0:
        return METEOR_INPUT_DEV0;     /* RCA   */
    case 1:
        return METEOR_INPUT_DEV1;     /* Tuner */
    case 2:
        return METEOR_INPUT_DEV2;     /* In 1  */
    case 3:
        return METEOR_INPUT_DEV3;     /* In 2  */
    case 4:
        return METEOR_INPUT_DEV_RGB;     /* RGB   */
    case 5:
        return METEOR_INPUT_DEV_SVIDEO; /* SVid  */
    }
