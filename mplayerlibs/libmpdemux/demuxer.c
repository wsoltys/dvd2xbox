...
void free_demuxer(demuxer_t *demuxer)
{
    ...
    case DEMUXER_TYPE_PVA:
        demux_close_pva(demuxer);
        break;
    case DEMUXER_TYPE_VIVO:
        demux_close_vivo(demuxer);
        break;
    case DEMUXER_TYPE_REAL:
        demux_close_real(demuxer);
        break;
    case DEMUXER_TYPE_Y4M:
        demux_close_y4m(demuxer);
        break;
    case DEMUXER_TYPE_MF:
        demux_close_mf(demuxer);
        break;
    case DEMUXER_TYPE_ROQ:
        demux_close_roq(demuxer);
        break;
    case DEMUXER_TYPE_FILM:
        demux_close_film(demuxer);
        break;
    case DEMUXER_TYPE_BMP:
        demux_close_bmp(demuxer);
        break;
    case DEMUXER_TYPE_FLI:
        demux_close_fli(demuxer);
        break;
    case DEMUXER_TYPE_NUV:
        demux_close_nuv(demuxer);
        break;
    case DEMUXER_TYPE_MPEG_TY:
        demux_close_ty(demuxer);
        break;
#if defined(USE_TV) && defined(HAVE_TV_V4L)
    case DEMUXER_TYPE_TV:
        demux_close_tv(demuxer);
        break;
#endif
#ifdef HAVE_LIBDV095
    case DEMUXER_TYPE_RAWDV:
        demux_close_rawdv(demuxer);
        break;
#endif
    ...
    case DEMUXER_TYPE_RTP:
        demux_close_rtp(demuxer);
        break;
#endif
    case DEMUXER_TYPE_SMJPEG:
        demux_close_smjpeg(demuxer);
        return;
    ...
    case DEMUXER_TYPE_XMMS:
        demux_close_xmms(demuxer);
        break;
#endif
#ifdef HAVE_GIF
    case DEMUXER_TYPE_GIF:
        demux_close_gif(demuxer)
        ;
        break;
#endif
    ...
    // free demuxers:
    if (demuxer->audio) free_demuxer_stream(demuxer->audio);
		demuxer->audio=NULL;
    if (demuxer->video) free_demuxer_stream(demuxer->video);
		demuxer->video=NULL;
    if (demuxer->sub) free_demuxer_stream(demuxer->sub);
		demuxer->sub=NULL;
    if(demuxer->info)
    {
...
int demux_fill_buffer(demuxer_t *demux,demux_stream_t *ds)
{
    ...
    {
    case DEMUXER_TYPE_MF:
        return demux_mf_fill_buffer(demux);
    case DEMUXER_TYPE_ROQ:
        return demux_roq_fill_buffer(demux);
    case DEMUXER_TYPE_FILM:
        return demux_film_fill_buffer(demux);
    case DEMUXER_TYPE_BMP:
        return demux_bmp_fill_buffer(demux);
    case DEMUXER_TYPE_FLI:
        return demux_fli_fill_buffer(demux);
    case DEMUXER_TYPE_MPEG_TY:
        return demux_ty_fill_buffer( demux );
    case DEMUXER_TYPE_MPEG4_ES:
    case DEMUXER_TYPE_H264_ES:
    case DEMUXER_TYPE_MPEG_ES:
        return demux_mpg_es_fill_buffer(demux);
    case DEMUXER_TYPE_MPEG_PS:
        return demux_mpg_fill_buffer(demux);
    case DEMUXER_TYPE_AVI:
        return demux_avi_fill_buffer(demux);
    case DEMUXER_TYPE_AVI_NI:
        return demux_avi_fill_buffer_ni(demux,ds);
    case DEMUXER_TYPE_AVI_NINI:
        return demux_avi_fill_buffer_nini(demux,ds);
    case DEMUXER_TYPE_ASF:
        return demux_asf_fill_buffer(demux);
    case DEMUXER_TYPE_MOV:
        return demux_mov_fill_buffer(demux,ds);
    case DEMUXER_TYPE_VIVO:
        return demux_vivo_fill_buffer(demux);
    case DEMUXER_TYPE_PVA:
        return demux_pva_fill_buffer(demux);
#ifdef HAVE_LIBDV095
    case DEMUXER_TYPE_RAWDV:
        return demux_rawdv_fill_buffer(demux);
#endif
    case DEMUXER_TYPE_REAL:
        return demux_real_fill_buffer(demux);
    case DEMUXER_TYPE_NUV:
        return demux_nuv_fill_buffer(demux);
#ifdef USE_TV
    case DEMUXER_TYPE_TV:
        return demux_tv_fill_buffer(demux, ds);
#endif
    case DEMUXER_TYPE_Y4M:
        return demux_y4m_fill_buffer(demux);
    case DEMUXER_TYPE_AUDIO:
        return demux_audio_fill_buffer(ds);
#ifdef HAVE_XMMS
    case DEMUXER_TYPE_XMMS:
        return demux_xmms_fill_buffer(demux,ds);
#endif
    case DEMUXER_TYPE_DEMUXERS:
        return demux_demuxers_fill_buffer(demux,ds);
#ifdef HAVE_OGGVORBIS
    case DEMUXER_TYPE_OGG:
        return demux_ogg_fill_buffer(demux);
#endif
#ifdef HAVE_MATROSKA
    case DEMUXER_TYPE_MATROSKA:
        return demux_mkv_fill_buffer(demux);
#endif
    case DEMUXER_TYPE_RAWAUDIO:
        return demux_rawaudio_fill_buffer(demux,ds);
    case DEMUXER_TYPE_RAWVIDEO:
        return demux_rawvideo_fill_buffer(demux,ds);
#ifdef STREAMING_LIVE_DOT_COM
    case DEMUXER_TYPE_RTP:
        return demux_rtp_fill_buffer(demux, ds);
#endif
    case DEMUXER_TYPE_SMJPEG:
        return demux_smjpeg_fill_buffer(demux);
#ifdef HAVE_GIF
    case DEMUXER_TYPE_GIF:
        return demux_gif_fill_buffer(demux);
#endif
    case DEMUXER_TYPE_MPEG_TS:
        return demux_ts_fill_buffer(demux);
    case DEMUXER_TYPE_REALAUDIO:
        return demux_ra_fill_buffer(demux);
    }
    return 0;
}
...
static demuxer_t* demux_open_stream(stream_t *stream,int file_format,int audio_id,int video_id,int dvdsub_id,char* filename)
{
    ...
    if(file_format==DEMUXER_TYPE_MPEG_ES || file_format==DEMUXER_TYPE_MPEG4_ES  || file_format==DEMUXER_TYPE_H264_ES)
    { // little hack, see above!
        ...
        else
        {
            ...
            case DEMUXER_TYPE_MPEG_ES:
                ...
                break;
            case DEMUXER_TYPE_MPEG4_ES:
                mp_msg(MSGT_DEMUXER,MSGL_INFO,MSGTR_Detected_XXX_FileFormat, "MPEG4-ES");
                break;
            case DEMUXER_TYPE_H264_ES:
                mp_msg(MSGT_DEMUXER,MSGL_INFO,MSGTR_Detected_XXX_FileFormat, "H264-ES");
                break;
            }
        }
    }
    ...
    case DEMUXER_TYPE_MF:
        {
            if (!demux_open_mf(demuxer))
                return NULL;
            break;
        }
    case DEMUXER_TYPE_FLI:
        {
            if (!demux_open_fli(demuxer))
                return NULL;
            break;
        }
    case DEMUXER_TYPE_FILM:
        {
            if (!demux_open_film(demuxer))
                return NULL;
            break;
        }
#ifdef HAVE_GIF
    ...
    case DEMUXER_TYPE_BMP:
        {
            if (!demux_open_bmp(demuxer))
                return NULL;
            break;
        }
    case DEMUXER_TYPE_ROQ:
        {
            if (!demux_open_roq(demuxer))
                return NULL;
            break;
        }
    case DEMUXER_TYPE_SMJPEG:
        {
            if (!demux_open_smjpeg(demuxer))
                return NULL;
            break;
        }
    case DEMUXER_TYPE_MOV:
        {
            if(!mov_read_header(demuxer))
                return NULL;
...
if(sh_audio)
...
#ifdef HAVE_LIBDV095
    case DEMUXER_TYPE_RAWDV:
        demux_seek_rawdv(demuxer,rel_seek_secs,flags);
        break;
#endif
    case DEMUXER_TYPE_AVI:
    ...
    case DEMUXER_TYPE_ASF:
        demux_seek_asf(demuxer,rel_seek_secs,flags);
        break;

    case DEMUXER_TYPE_MPEG_TY:
        demux_seek_ty(demuxer,rel_seek_secs,flags);
        break;
    ...
    case DEMUXER_TYPE_MPEG_ES:
    case DEMUXER_TYPE_MPEG_PS:
        demux_seek_mpg(demuxer,rel_seek_secs,flags);
        break;

    case DEMUXER_TYPE_MOV:
        demux_seek_mov(demuxer,rel_seek_secs,flags);
        break;

    case DEMUXER_TYPE_REAL:
        demux_seek_real(demuxer,rel_seek_secs,flags);
        break;

    case DEMUXER_TYPE_Y4M:
        demux_seek_y4m(demuxer,rel_seek_secs,flags);
        break;

    case DEMUXER_TYPE_MF:
        demux_seek_mf(demuxer,rel_seek_secs,flags);
        break;

    case DEMUXER_TYPE_PVA:
        demux_seek_pva(demuxer,rel_seek_secs,flags);
        break;

    case DEMUXER_TYPE_FLI:
        demux_seek_fli(demuxer,rel_seek_secs,flags);
        break;
    case DEMUXER_TYPE_FILM:
        demux_seek_film(demuxer,rel_seek_secs,flags);
        break;
    case DEMUXER_TYPE_NUV:
        demux_seek_nuv(demuxer,rel_seek_secs,flags);
        break;
    case DEMUXER_TYPE_AUDIO:
...
#endif
    case DEMUXER_TYPE_RAWAUDIO:
        demux_rawaudio_seek(demuxer,rel_seek_secs,flags);
        break;
    case DEMUXER_TYPE_RAWVIDEO:
        demux_rawvideo_seek(demuxer,rel_seek_secs,flags);
        break;
#ifdef HAVE_XMMS
    case DEMUXER_TYPE_XMMS:
        demux_xmms_seek(demuxer,rel_seek_secs,flags);
        break;
#endif
#ifdef HAVE_MATROSKA
    case DEMUXER_TYPE_MATROSKA:
        demux_mkv_seek(demuxer,rel_seek_secs,flags);
        break;
#endif
    case DEMUXER_TYPE_MPEG_TS:
        demux_seek_ts(demuxer,rel_seek_secs,flags);
        break;
...
extern int demux_pva_control(demuxer_t *demuxer, int cmd, void *arg);
int demux_control(demuxer_t *demuxer, int cmd, void *arg)
{
    ...
    case DEMUXER_TYPE_PVA:
        return demux_pva_control(demuxer,cmd,arg);
    case DEMUXER_TYPE_AUDIO:
