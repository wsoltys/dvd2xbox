...
static demux_packet_t* new_demux_packet(int len){
...
static demux_packet_t* clone_demux_packet(demux_packet_t* pack){
  demux_packet_t* dp=(demux_packet_t*)malloc(sizeof(demux_packet_t));
...
static void free_demux_packet(demux_packet_t* dp){
...
static off_t ds_tell(demux_stream_t *ds){
  return (ds->dpos-ds->buffer_size)+ds->buffer_pos;
}

static int ds_tell_pts(demux_stream_t *ds){
...
#else
static int demux_getc(demux_stream_t *ds){
...
static int avi_stream_id(unsigned int id){
