...
stream_t* open_cdda(char* dev,char* track)
{
    ...
    else
    {
        ...
        {
			//	CHANGED BOBBIN007
            char* st = calloc(st_len + 1, sizeof(char));
			//	END BOBBIN007
        ...
        {
			//	CHANGED BOBBIN007
            char* ed = calloc(ed_len + 1, sizeof(char));
			//	END BOBBIN007
...
//	REPLACED BOBBIN007 MPlayer 0.90
