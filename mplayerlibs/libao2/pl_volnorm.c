...
static int init()
{
    ...
    case(AFMT_S16_NE):
                    break;
    default:
        mp_msg(0,0,"[pl_volnorm] Audio format not yet supported.\n");
        return 0;
    }
    ...
    mp_msg(0,0,"[pl_volnorm] Normalizer plugin in use.\n");
    return 1;
}
...
for(i=0; i < NSAMPLES; ++i)
        ...
        break;
    default:
        mp_msg(0,0,"[pl_volnorm] internal inconsistency - bugreport !\n");
        *(char *) 0 = 0;
    }
}
