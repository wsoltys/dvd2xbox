...
public:
	...
	void showScrollWindow2(float x,float y,int width,int widthpx,int vspace,int lines,DWORD fc,DWORD hlfc,const CStdString& font, DWORD dwFlags=0L);
	...
	void showScrollWindowSTR2(float x,float y,int width, int widthpx,int vspace, int lines,DWORD fc,DWORD hlfc,const CStdString& font,DWORD dwFlags=0L);
